...
function createPropertiesTable(props, drawn) {
        ...
        for (var key in props) {
            ...
            switch (key) {
                ...
                case "type":
                    ...
                    placeholder.appendChild(parent_node);
                    //console.log(document.getElementById("id_source_select"));
                    ////debugger;
            ...
            //var test4 = document.getElementById("type_placeholder").querySelector("input").value;

        }

        var test3 = document.getElementById("type_placeholder").querySelector("input").value;
        // //debugger;
    ...
    //var test2 = document.getElementById("type_placeholder").querySelector("input").value;
    ////debugger;
}
    ...
    for (var i = 0; i < elems_1.length; i++) {
        switch (elems_1[i].innerText) {
            ...
            case "polution": case "range":
                ...
                break;
            case "profile":
                //N�o precisa de ficar editable devido ao botao 'edit profile'
...
function alphabetKeyPressed(e) {
    ...
    //Os keyCodes das letras no meu teclado s�o diferentes dos apresentados em keycode.info
...
function loadTagList() {
    ...
    // //input.remove();
    // //var editor_input = parent_node.querySelector("#editor_input");
    // addTypeDropdownMenu(editor_input, options, props["type"]);
    // editor_input.querySelector("input").oninput = function () { selection_obj.type = this.value };
    //placeholder.appendChild(parent_node);
